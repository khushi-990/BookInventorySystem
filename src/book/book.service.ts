...
export class BookService {
    ...
    async deleteBook(body: DetailsBasedOnIdDto) {
        return await this.commonService.deleteById(this.bookModel, body._id, RESPONSE_ERROR.BOOK_DELETED);
    }
    ...
    async findOne(_id: string) {
        return await this.commonService.getDetails(this.bookModel, _id, RESPONSE_ERROR.BOOK_NOT_FOUND)
    }
